                      ...
                      GestureDetector(
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(width: MediaQuery.of(context).size.width*0.4,height:MediaQuery.of(context).size.height*0.21 ,
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Image(image: NetworkImage(
                                      'https://i.pinimg.com/236x/07/b5/ff/07b5ff2a8a2ab5dd7d29f31d5d73835e.jpg'),height: 130,width: 130,)
                                 , SizedBox(height: 4),
                                  Text(
                        ...
                        Text(
                        'Specialization: ${dummyHospitals[index]
                    .specialization}',
                                  style: TextStyle(overflow: TextOverflow.ellipsis,
